...
These extracted features enable both new integer generation and integer prediction on test examples. Here we focus on the latter ( mostly because I thought it was more interesting).
...
[ADD ME] Image of digit skeleton
...
Predict a test digit using Bayes Rule
